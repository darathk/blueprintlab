...
async function run() {
    const coachId = 'user_2kH3rZIf0v55WLYL01z22V9q09k'; // Just assuming it doesn't use coachId if I query coach directly
    ...
    for (const row of rows) {
        ...
        console.log(`Athlete: ${row.athleteName}, W: ${weekNum}, D: ${dayNum}, Fallback: ${usedFallback}, SessionID: ${row.sessionId}`);
    }
    prisma.$disconnect();
}
run();
