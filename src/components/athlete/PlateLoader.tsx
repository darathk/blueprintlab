...
const PLATES = [
    ...
    { weight: 2, color: '#e2e8f0', label: '2', text: '#000', width: 16, height: 100, border: '#cbd5e1' }, // Silver
    { weight: 1.5, color: '#e2e8f0', label: '1.5', text: '#000', width: 14, height: 95, border: '#cbd5e1' }, // Silver
