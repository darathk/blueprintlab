...
const TABS: { id: StrengthSuiteTab; label: string; fullLabel?: string }[] = [
    { id: 'barbell', label: 'Barbell' },
    { id: 'rpe', label: 'RPE' },
    { id: 'points', label: 'Points' },
    { id: 'max', label: 'Max' },
    { id: 'feds', label: 'Feds', fullLabel: 'Compare Feds' },
];
...
export default function StrengthSuite({
    ...
    return (
        <div className="w-full flex flex-col items-center">
            ...
            <div className={`w-full relative flex items-center justify-center mb-5 sm:mb-6 ${isModal && onClose ? 'px-8 sm:px-2' : 'px-1 sm:px-2'}`}>
                <div className="w-full overflow-x-auto no-scrollbar scroll-smooth py-1">
                    <div className="flex min-w-full w-max justify-center px-2 sm:px-0">
                        <div
                            ...
                            {TABS.map((tab) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="chat-press flex items-center justify-center px-2.5 sm:px-5 py-1.5 sm:py-2.5 rounded-full transition-all cursor-pointer select-none whitespace-nowrap shrink-0 hover:text-white min-h-[34px] sm:min-h-[42px]"
                                        style={{
